<%@ Page Title="Book Fine" Language="C#" MasterPageFile="~/Admin/AdminSite.Master" AutoEventWireup="true" CodeBehind="BookFine.aspx.cs" Inherits="LMS_Project.Admin.BookFine" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="contiainer">
        <div class="row border align-content-center" id="row1" runat="server" visible="true">
            Hi,<asp:Label ID="lblMembername" runat="server" Text="Label" Font-Bold="true" Font-Size="Large"></asp:Label>
            &nbsp;
        ...
        <div class="row" id="row2" runat="server" visible="false">
            <div class="col-75" >
                <div class="container">
                    <div class="row">
                        <div class="col-50">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*pleade enter name" ForeColor="Red"  ControlToValidate="txtFullName" ValidationGroup="paymentbtn"></asp:RequiredFieldValidator>
                            <label for="email"><i class="fa fa-envelope"></i> Email</label>
                            <asp:TextBox ID="txtEmail" runat="server" placeholder="abc@gmail.com"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*pleade enter valid Email" ForeColor="Red"  ControlToValidate="txtEmail" ValidationGroup="paymentbtn"></asp:RequiredFieldValidator>
                            ...
                            <div class="row">
                                ...
                                <div class="col-50">
                                    ...
                                    <asp:TextBox ID="txtzip" runat="server" placeholder="400001"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-50">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ControlToValidate="txtAmount" runat="server" ErrorMessage="enter amount" ValidationGroup="paymentbtn" ReadOnly="true"></asp:RequiredFieldValidator>
        ...
        <a href="AdminHome.aspx" runat="server" visible="false"> << Back to Home</a>
    </div>
</asp:Content>
