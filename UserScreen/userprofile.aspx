<%@ Page Title="User Profile" Language="C#" MasterPageFile="~/UserScreen/User.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="LMS_Project.UserScreen.userprofile" %>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="100" src="../Logoimg/user1.jpg" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
